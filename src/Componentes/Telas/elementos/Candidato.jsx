...
export default function Candidato(props) {
    ...
    const [descurtidas, setdescurtidas]=useState(props.candidato.descurtidas);
        ...
        function curtirCandidato (candidato) {
            setcurtidas(candidato.curtidas+1);
            candidato.curtidas = candidato.curtidas+1;

        }

        function descurtirCandidato (candidato) {
        ...
        return (
            ...
            <Card.Body>
                ...
                <Button onClick={() => { curtirCandidato(props.candidato) }} variant="primary"> {//Curtir
                                           }
                ...
                </Button> <Button onClick={() => { descurtirCandidato(props.candidato) }} variant="primary"> {//Não Curtir
                                           }
